...
var increaseIndex = function() {
    let numberValue = parseInt(index_page.text());
    // let total = parseInt(totalResult.text());
    // let maxPage = Math.ceil(total/2);
    // console.log(maxPage);
    // index_page.text(Math.min(numberValue + 1, maxPage));
    index_page.text(numberValue + 1)
    viewlist();
...
var viewlist = function () {
    ...
    $.ajax({
        url: "http://localhost:8080/Assignment03_war/employee/search", // Đường dẫn tới tài nguyên hoặc API bạn muốn truy cập
